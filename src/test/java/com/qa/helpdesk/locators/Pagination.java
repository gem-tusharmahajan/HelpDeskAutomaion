...
{
    public static By pagePerDropdown=By.xpath("//div[contains(@class,'MuiInputBase-root MuiInputBase-colorPrimary')]");

    public static By value(String str) throws InterruptedException
    {
        return By.xpath("//select/option[@value='"+str+"']");
    }
    public static By displayedTickets=By.xpath("//tbody[contains(@class,'MuiTableBody-root')]/tr");
